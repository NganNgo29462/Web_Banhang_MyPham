<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tamduongthe.aspx.cs" Inherits="Doan_thuchanhnghenghiep.Tamduongthe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_homecontent" runat="server">
    <p style="font-family: 'Segoe UI'; color: black; font-size: 32px; text-align: center;">TẮM & DƯỠNG THỂ</p><br />

        <section class="container">
            <div class="tenloai">
                <p style="font-family: 'Segoe UI'; color: black; font-size: 32px; text-align: center;">Tẩy tế bào chết cơ thể</p><br />
...
<asp:SqlDataSource ID="srcl1" runat="server" 
    ...
    SelectCommand="SELECT MaSP, TenSP, GiaBan, HinhSP FROM SanPham  where MaloaiSP='LSP15'">
    </asp:SqlDataSource>
        
    </section>
            <section class="container">
            <div class="tenloai">
                <p style="font-family: 'Segoe UI'; color: black; font-size: 32px; text-align: center;">Sữa tắm</p><br />
...
<asp:SqlDataSource ID="srcl2" runat="server" 
    ConnectionString="<%$ ConnectionStrings:QLMPConnectionString %>" 
    SelectCommand="SELECT MaSP, TenSP, GiaBan, HinhSP FROM SanPham  where MaloaiSP='LSP16'">
    </asp:SqlDataSource>
        
    </section>
            <section class="container">
            <div class="tenloai">
                <p style="font-family: 'Segoe UI'; color: black; font-size: 32px; text-align: center;">Xịt cơ thể</p><br />
...
<asp:SqlDataSource ID="srcl3" runat="server" 
    ConnectionString="<%$ ConnectionStrings:QLMPConnectionString %>" 
    SelectCommand="SELECT MaSP, TenSP, GiaBan, HinhSP FROM SanPham  where MaloaiSP='LSP17'">
    </asp:SqlDataSource>
        
    </section>
            <section class="container">
            <div class="tenloai">
                <p style="font-family: 'Segoe UI'; color: black; font-size: 32px; text-align: center;">Dưỡng thể</p><br />
...
<asp:SqlDataSource ID="srcl4" runat="server" 
    ConnectionString="<%$ ConnectionStrings:QLMPConnectionString %>" 
    SelectCommand="SELECT MaSP, TenSP, GiaBan, HinhSP FROM SanPham  where MaloaiSP='LSP18'">
    </asp:SqlDataSource>
