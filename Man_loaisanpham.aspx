<%@ Page Title="Quản lý loại sản phẩm" Language="C#" MasterPageFile="~/SiteManager.Master" AutoEventWireup="true" CodeBehind="Man_loaisanpham.aspx.cs" Inherits="Doan_thuchanhnghenghiep.Man_loaisanpham" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_homecontent2" runat="server">
    <p style="font-family: 'Plus Jakarta Sans'; color: rgba(197, 162, 93, 1); font-size: 32px; text-align: center;">LOẠI SẢN PHẨM</p><br />
    
    <!-- GridView for displaying products -->
    <asp:GridView ID="grdLoaiSanPham" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
        CellPadding="4" DataKeyNames="MaloaiSP" DataSourceID="srcLSP" GridLines="Horizontal" 
        PageSize="20" Width="100%" BackColor="White" BorderColor="#C5A25D" BorderStyle="Solid" BorderWidth="1px"
        OnRowDataBound="grdLoaiSanPham_RowDataBound">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="MaloaiSP" HeaderText="Mã loại sản phẩm" ReadOnly="True" SortExpression="MaSP">
    ...
    <asp:SqlDataSource ID="srcLSP" runat="server" 
        ...
        DeleteCommand="DELETE FROM LoaiSanPham WHERE MaloaiSP = @MaloaiSP" 
        SelectCommand="SELECT MaloaiSP, MadongSP, TenloaiSP FROM LoaiSanPham" 
        UpdateCommand="UPDATE LoaiSanPham SET MadongSP=@MadongSP, TenloaiSP=@TenloaiSP  WHERE MaloaiSP=@MaloaiSP">
        <DeleteParameters>
    ...
    <div class="btn_con">
        <asp:Button ID="btnShowModal" CssClass="btn btnshow" runat="server" Text="Thêm loại sản phẩm" OnClick="btnShowModal_Click"/>
    </div>
    ...
    <table style="width: 100%; font-size:16px; color:rgba(31, 28, 23);">
        <tr>
            <td style="width: 30%">Mã loại sản phẩm</td>
            <td><asp:TextBox ID="txtMaloaiSP" runat="server"  CssClass="textbox"></asp:TextBox></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 20%">Tên loại sản phẩm</td>
            <td><asp:TextBox ID="txtTenloaiSP" runat="server" CssClass="textbox"></asp:TextBox></td>
            <td>&nbsp;</td>
        </tr>
    ...
    ConnectionString="<%$ ConnectionStrings:QLMPConnectionString %>" 
    SelectCommand="SELECT MaloaiSP, MadongSP, TenloaiSP FROM LoaiSanPham" 
    InsertCommand="INSERT INTO LoaiSanPham (MaloaiSP, MadongSP, TenloaiSP) VALUES (@MaloaiSP, @MadongSP, @TenloaiSP)">
</asp:SqlDataSource>
